/*
 * $Id: Characteristic.java,v 1.21 2004/11/04 08:51:00 bob Exp $
 *
...
/**
 * @version $Revision: 1.21 $, $Date: 2004/11/04 08:51:00 $
 * @author $Author: bob $
	...
	protected static CharacteristicSort getSortForId(Identifier id) throws IllegalDataException{
		...
		switch(id.getMajor()){
			...
			case ObjectEntities.MEASUREMENTPORT_ENTITY_CODE:
				sort = CharacteristicSort.CHARACTERISTIC_SORT_MEASUREMENTPORT;
				break;				
			default:
