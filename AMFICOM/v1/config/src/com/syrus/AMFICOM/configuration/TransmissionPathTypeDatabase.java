/*
 * $Id: TransmissionPathTypeDatabase.java,v 1.42 2005/07/25 20:49:45 arseniy Exp $
 *
...
/**
 * @version $Revision: 1.42 $, $Date: 2005/07/25 20:49:45 $
...
public final class TransmissionPathTypeDatabase extends StorableObjectDatabase {
	...
	protected StorableObject updateEntityFromResultSet(final StorableObject storableObject, final ResultSet resultSet)
		...
		if (transmissionPathType == null) {
			transmissionPathType = new TransmissionPathType(DatabaseIdentifier.getIdentifier(resultSet, StorableObjectWrapper.COLUMN_ID),
					null,
