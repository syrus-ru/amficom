/*-
 * $Id: MeasurementPortFactory.java,v 1.3 2005/06/22 10:05:17 bass Exp $
 *
...
final class MeasurementPortFactory extends StorableObjectFactory {
	...
	protected StorableObject newInstance(final IDLEntity transferable) throws CreateObjectException {
		return new MeasurementPort((IdlMeasurementPort) transferable);
	}
	...
	protected Identifier getId(final IDLEntity transferable) {
		return new Identifier(((IdlMeasurementPort) transferable).header.id);
	}
