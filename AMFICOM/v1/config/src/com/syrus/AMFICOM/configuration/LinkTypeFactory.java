/*-
 * $Id: LinkTypeFactory.java,v 1.3 2005/06/22 10:05:17 bass Exp $
 *
...
final class LinkTypeFactory extends StorableObjectFactory {
	...
	protected StorableObject newInstance(final IDLEntity transferable) throws CreateObjectException {
		return new LinkType((IdlLinkType) transferable);
	}
	...
	protected Identifier getId(final IDLEntity transferable) {
		return new Identifier(((IdlLinkType) transferable).header.id);
	}
