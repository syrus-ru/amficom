/*
 * $Id: PortTypeWrapper.java,v 1.1 2005/01/26 13:18:49 bob Exp $
 *
 ...
 */
public final class PortTypeWrapper implements Wrapper {
		...
		if (object instanceof PortType) {
			...
			if (key.equals(COLUMN_NAME))
				...
				try {
					...
					Log.errorMessage("PortTypeWrapper.setValue | key '" + key + "' caught " + e.getMessage());
				}
			}
		}
	}
