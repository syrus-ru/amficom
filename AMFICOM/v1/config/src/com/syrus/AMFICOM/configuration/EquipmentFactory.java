/*-
 * $Id: EquipmentFactory.java,v 1.3 2005/06/22 10:05:17 bass Exp $
 *
...
final class EquipmentFactory extends StorableObjectFactory {
	...
	protected StorableObject newInstance(final IDLEntity transferable) throws CreateObjectException {
		return new Equipment((IdlEquipment) transferable);
	}
	...
	protected Identifier getId(final IDLEntity transferable) {
		return new Identifier(((IdlEquipment) transferable).header.id);
	}
