/*
 * $Id: AbstractLinkType.java,v 1.34 2006/06/02 17:23:22 bass Exp $
 *
...
/**
 * @version $Revision: 1.34 $, $Date: 2006/06/02 17:23:22 $
 * @author $Author: bass $
 * @module config
 */
public abstract class AbstractLinkType
	 ...
	 */
	@Override
	protected final Set<Identifiable> getReverseDependencies(final boolean usePool)
	throws ApplicationException {
