/*-
 * $Id: CableThreadType.java,v 1.90.2.1 2006/05/18 17:46:15 bass Exp $
 *
 ...
 *
 * @version $Revision: 1.90.2.1 $, $Date: 2006/05/18 17:46:15 $
 * @author $Author: bass $
...
public final class CableThreadType extends StorableObjectType
	 ...
	 */
	public void getXmlTransferable(final XmlCableThreadType cableThreadType, final String importType)
			throws XmlConversionException {
		assert this.isValid() : OBJECT_STATE_ILLEGAL;
