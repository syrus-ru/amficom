/*
 * $Id: Equipment.java,v 1.161.2.1 2006/05/18 17:46:15 bass Exp $
 *
...
/**
 * @version $Revision: 1.161.2.1 $, $Date: 2006/05/18 17:46:15 $
 * @author $Author: bass $
...
public final class Equipment extends DomainMember
	...
	public void fromXmlTransferable(final XmlEquipment equipment, final String importType) throws XmlConversionException {
		try {
			...
			if (equipment.isSetDomainId()) {
				...
				throw new XmlConversionException("Equipment.fromXmlTransferable() | " + XML_BEAN_NOT_COMPLETE);
			}
	 ...
	 */
	public void getXmlTransferable(final XmlEquipment equipment, final String importType)
			throws XmlConversionException {
		try {
			...
			final Set<Characteristic> characteristics = this.getCharacteristics();
