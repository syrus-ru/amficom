...
public final class MapCablePathController 
		implements ObjectResourcePropertiesController 
{

	private static MapCablePathController instance;

	private List keys;

	private MapCablePathController() 
	{
	...
	public static MapCablePathController getInstance() 
	{
		if (instance == null)
			instance = new MapCablePathController();
		return instance;
	}
