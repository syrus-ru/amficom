/*-
 * $$Id: DeleteNodeCommandBundle.java,v 1.56 2006/02/14 10:20:06 stas Exp $$
 *
 ...
 * 
 * @version $Revision: 1.56 $, $Date: 2006/02/14 10:20:06 $
 * @author $Author: stas $
...
public class DeleteNodeCommandBundle extends MapActionCommandBundle {
	...
	@Override
	public void execute() {
		Log.debugMessage("delete node "  //$NON-NLS-1$
