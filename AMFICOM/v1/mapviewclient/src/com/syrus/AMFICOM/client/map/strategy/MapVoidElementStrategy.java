/*-
 * $$Id: MapVoidElementStrategy.java,v 1.37 2005/10/02 13:06:50 krupenn Exp $$
 *
 ...
 * 
 * @version $Revision: 1.37 $, $Date: 2005/10/02 13:06:50 $
...
public final class MapVoidElementStrategy extends AbstractMapStrategy {
	...
	protected void selectElementsInRect(Rectangle selectionRect)
		...
		Log.debugMessage(
			"MapVoidElementStrategy.selectElementsInRect | " //$NON-NLS-1$ 
				+ (t2 - t1) + " ns ", //$NON-NLS-1$ 
			Level.FINE);
	}
}
