/*-
 * $$Id: DeleteNodeLinkCommandBundle.java,v 1.46 2005/10/31 12:30:07 bass Exp $$
 *
 ...
 * 
 * @version $Revision: 1.46 $, $Date: 2005/10/31 12:30:07 $
 * @author $Author: bass $
...
public class DeleteNodeLinkCommandBundle extends MapActionCommandBundle {
	...
	@Override
	public void execute() {
		Log.debugMessage("delete nodeLink "  //$NON-NLS-1$
