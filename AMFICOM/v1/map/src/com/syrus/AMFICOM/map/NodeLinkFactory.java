/*-
 * $Id: NodeLinkFactory.java,v 1.3 2005/06/01 18:49:46 bass Exp $
 *
...
final class NodeLinkFactory extends StorableObjectFactory {
	...
	protected Identifier getId(final IDLEntity transferable) {
		return new Identifier(((NodeLink_Transferable) transferable).header.id);
	}
	...
	protected IDLEntity[] allocateArrayOfTransferables(final int length) {
		return new NodeLink_Transferable[length];
	}
}
