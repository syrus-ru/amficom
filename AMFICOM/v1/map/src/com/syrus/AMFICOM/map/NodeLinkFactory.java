/*-
 * $Id: NodeLinkFactory.java,v 1.4 2005/06/24 10:41:46 bass Exp $
 *
...
final class NodeLinkFactory extends StorableObjectFactory {
	...
	protected StorableObject newInstance(final IDLEntity transferable) throws CreateObjectException {
		return new NodeLink((IdlNodeLink) transferable);
	}
	...
	protected Identifier getId(final IDLEntity transferable) {
		return new Identifier(((IdlNodeLink) transferable).header.id);
	}
