/*-
 * $Id: SiteNodeFactory.java,v 1.4 2005/06/24 10:41:46 bass Exp $
 *
...
final class SiteNodeFactory extends StorableObjectFactory {
	...
	protected StorableObject newInstance(final IDLEntity transferable) throws CreateObjectException {
		return new SiteNode((IdlSiteNode) transferable);
	}
	...
	protected Identifier getId(final IDLEntity transferable) {
		return new Identifier(((IdlSiteNode) transferable).header.id);
	}
