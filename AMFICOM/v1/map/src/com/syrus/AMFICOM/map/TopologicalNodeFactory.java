/*-
 * $Id: TopologicalNodeFactory.java,v 1.4 2005/06/24 10:41:46 bass Exp $
 *
...
final class TopologicalNodeFactory extends StorableObjectFactory {
	...
	protected StorableObject newInstance(final IDLEntity transferable) throws CreateObjectException {
		return new TopologicalNode((IdlTopologicalNode) transferable);
	}
	...
	protected Identifier getId(final IDLEntity transferable) {
		return new Identifier(((IdlTopologicalNode) transferable).header.id);
	}
