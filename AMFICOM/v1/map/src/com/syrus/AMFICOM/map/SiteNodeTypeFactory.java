/*-
 * $Id: SiteNodeTypeFactory.java,v 1.4 2005/06/24 10:41:46 bass Exp $
 *
...
final class SiteNodeTypeFactory extends StorableObjectFactory {
	...
	protected StorableObject newInstance(final IDLEntity transferable) throws CreateObjectException {
		return new SiteNodeType((IdlSiteNodeType) transferable);
	}
	...
	protected Identifier getId(final IDLEntity transferable) {
		return new Identifier(((IdlSiteNodeType) transferable).header.id);
	}
