/*-
 * $Id: CollectorFactory.java,v 1.4 2005/06/24 10:41:46 bass Exp $
 *
...
final class CollectorFactory extends StorableObjectFactory {
	...
	protected StorableObject newInstance(final IDLEntity transferable) throws CreateObjectException {
		return new Collector((IdlCollector) transferable);
	}
	...
	protected Identifier getId(final IDLEntity transferable) {
		return new Identifier(((IdlCollector) transferable).header.id);
	}
