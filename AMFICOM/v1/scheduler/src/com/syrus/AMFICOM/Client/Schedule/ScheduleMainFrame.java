/*-
* $Id: ScheduleMainFrame.java,v 1.55.4.1 2006/06/27 14:40:10 saa Exp $
*
...
/**
 * @version $Revision: 1.55.4.1 $, $Date: 2006/06/27 14:40:10 $
 * @author $Author: saa $
...
//				normalize(saveFrame);
				...
				if (this.timeFrameHeight == 0) {
					this.timeFrameHeight = 7 * timeFrame.getHeight() / 4;
				}
