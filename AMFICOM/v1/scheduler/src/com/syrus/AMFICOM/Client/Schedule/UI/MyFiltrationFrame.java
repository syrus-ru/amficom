...
public class MyFiltrationFrame extends JInternalFrame
		implements OperationListener
{
	...
	public MyFiltrationFrame(ScheduleMDIMain parent, ApplicationContext aContext, DataSet ds)
	{
		this.dataSet = ds;
	...
	private void jbInit() throws Exception
	{
		...
		timeRadioButton.setText(LangModelScheduleOld.String("labelTime"));
		...
		listRadioButton.setText(LangModelScheduleOld.String("labelList"));
		...
		eqRadioButton.setText(LangModelScheduleOld.String("labelEqual"));
		...
		rangeRadioButton.setText(LangModelScheduleOld.String("labelRange"));
		...
		subRadioButton.setText(LangModelScheduleOld.String("labelSubstring"));
		...
		addButton.setText(LangModelScheduleOld.String("labelAdd"));
		...
		changeButton.setText(LangModelScheduleOld.String("labelChange"));
		changeButton.setEnabled(false);
...
//		this.setMaximizable(true);
		...
		this.setTitle(LangModelScheduleOld.String("MyFiltrationTitle"));
		...
		jLabel1.setText(LangModelScheduleOld.String("labelCriteriaFilt"));
		...
		doFilterButton.setText(LangModelScheduleOld.String("labelFilter"));
...
//		toolBar.setModel(aModel);
	...
	void this_mousePressed (MouseEvent e)
	{
		...
		if (SwingUtilities.isRightMouseButton(e))
		{
			...
			JMenuItem delete = new JMenuItem(LangModelScheduleOld.String("labelCriteriaDel"));
...
//			return;
	...
	void addButton_actionPerformed(ActionEvent e)
	{
		...
		FilterExpression expr = (FilterExpression )fp.getExpression(col_id, col_name, true);
