...
public class MyTreeCommand extends VoidCommand
{
  ScheduleMDIMain parent;
  ApplicationContext aContext;

	public MyTreeCommand()
	{
	}

	public MyTreeCommand(ScheduleMDIMain parent, ApplicationContext aContext)
	{
	  this.parent = parent;
	...
	public Object clone()
	{
		return new MyTreeCommand(parent, aContext);
	}
	...
	public void resize()
	{
		...
		{
			if (fram[i] instanceof MyTreeFrame)
			{
				 fram[i].toFront();
	...
	public void execute()
	{
		...
		if (bool == false)
		{
			MyTreeFrame frame = new MyTreeFrame(parent, aContext);
