...
final class PlanPanel extends JPanel implements ActionListener, PropertyChangeListener {
	...
	private final static class Step {
		...
		int	align;		// ‚˚‡‚ÌË‚‡ÌËÂ ÔÓ Í‡ÚÌÓÏÛ

		int	one;		// ˜ËÒÎÓ Â‰ËÌËˆ ËÁÏÂÂÌËˇ ‚ÌÛÚË Ó‰ÌÓ„Ó ‰ÂÎÂÌËˇ

		int	scale;		// ÒÚÂÔÂÌ¸ „‡‰‡ˆËË ÓÒÌÓ‚Ì˚ı ‰ÂÎÂÌËÈ ¯Í‡Î˚

		int	subscales;	// ˜ËÒÎÓ ‰ÓÔÓÎÌËÚÂÎ¸Ì˚ı ‰ÂÎÂÌËÈ ‚ÌÛÚË ÓÒÌÓ‚ÌÓ„Ó

		int	total;		// Ó·˘ÂÂ ˜ËÒÎÓ Â‰ËÌËˆ ËÁÏÂÂÌËˇ
	...
	private Date					startDate			= new Date(); // ‹‘œ "–Ãœ»œ≈" ⁄Œ¡ﬁ≈Œ…≈, ◊ Œ≈Õ ≈”‘ÿ ”≈À’ŒƒŸ … Õ…ÃÃ…”≈À’ŒƒŸ, Œœ ◊ ÀœŒ”‘“’À‘œ“≈ ◊”≈ “¡◊Œœ ¬’ƒ≈‘ ◊Ÿ⁄◊¡Œ setStartDate()
