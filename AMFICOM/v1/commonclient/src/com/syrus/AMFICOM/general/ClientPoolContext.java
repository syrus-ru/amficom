/*
 * $Id: ClientPoolContext.java,v 1.7 2005/06/08 16:11:41 arseniy Exp $
 * 
...
//	}
	...
	public void init() {
		GeneralStorableObjectPool.init(new CORBAGeneralObjectLoader(this.clientServantManager), StorableObjectResizableLRUMap.class);
