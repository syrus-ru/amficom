 ...
 * @module manager
 */
public class RolePermissionBeanUI extends AbstractBeanUI<RolePermissionBean> {
	...
	private RolePermissionBean	bean;
	
	private Map<Module, Icon> iconCache;
	private Map<Module, Icon> imageCache;

	public RolePermissionBeanUI(final ManagerMainFrame managerMainFrame) {
...
// 					model.fireTableRowsUpdated(rowIndex, rowIndex);
	...
	private void updateTable(final RolePermissionBean bean) {		
	...
	@Override
	public JPanel getPropertyPanel(final RolePermissionBean bean) {		
		this.bean = bean;
	...
	@Override
	public Icon getIcon(AbstractBeanFactory<RolePermissionBean> factory) {
		return this.getCachedIcon(((RolePermissionBeanFactory)factory).getModule());
	}
	
	@Override
	public Icon getImage(final RolePermissionBean bean) {
	...
	private class PermissionTableModel extends AbstractTableModel {
		...
		private RolePermissionBean	permissionBean;
		private PermissionAttributes	permissionAttributes;
		private List<String>	keys;
		private PermissionBeanWrapper	permissionBeanWrapper;

		public void setPermissionBean(final RolePermissionBean	permissionBean) {
