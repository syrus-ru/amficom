...
public class AdministrateToolBar extends JToolBar implements ApplicationModelListener
{
  ...
  private void jbInit() throws Exception
  {
    ...
    buttonOpenSession.setToolTipText(LangModelAdmin.ToolTip("menuSessionNew"));
    ...
    buttonCloseSession.setToolTipText(LangModelAdmin.ToolTip("menuSessionClose"));
...
//    add(buttonCloseSession);
    ...
    buttonNavigator.setToolTipText(LangModelAdmin.ToolTip("menuViewNavigator"));
    ...
    buttonCurrentUser.setToolTipText(LangModelAdmin.ToolTip("menuViewWhoAmI"));
    ...
    buttonViewOpenAll.setToolTipText(LangModelAdmin.ToolTip("menuViewOpenAll"));
...
//    add(buttonViewOpenAll);
    ...
    buttonDomain.setToolTipText(LangModelAdmin.ToolTip("menuAccessDomain"));
    ...
    buttonClient.setToolTipText(LangModelAdmin.ToolTip("menuArchitectureClient"));
    ...
    buttonServer.setToolTipText(LangModelAdmin.ToolTip("menuArchitectureServer"));
    ...
    buttonAgent.setToolTipText(LangModelAdmin.ToolTip("menuArchitectureAgent"));
    ...
    buttonCategory.setToolTipText(LangModelAdmin.ToolTip("menuUserCategory"));
    ...
    buttonCommand.setToolTipText(LangModelAdmin.ToolTip("menuAccessModul"));
    ...
    buttonGroup.setToolTipText(LangModelAdmin.ToolTip("menuUserGroup"));
    ...
    buttonProfile.setToolTipText(LangModelAdmin.ToolTip("menuUserProfile"));
	...
	buttonMaintenance.setToolTipText(LangModelAdmin.ToolTip("menuAccessMaintain"));
