/*
 * $Id: IdentifierLoader.java,v 1.1 2005/01/21 06:56:37 max Exp $
 *
...
/**
 * @version $Revision: 1.1 $, $Date: 2005/01/21 06:56:37 $
 * @author $Author: max $
 * @module module
 */
public class IdentifierLoader extends SleepButWorkThread {

	private ARServer	server;
	private Fifo		idPool;
	private short		entityCode;
	private static int	timeToSleep	= 1000;

	public IdentifierLoader(ARServer server, Fifo idPool, short entityCode) {
		super(timeToSleep);
		this.server = server;
		this.idPool = idPool;
