...
"${AMFICOM_HOME}"/arserver_v1/classes

CMDLINE="${JAVA_HOME}/bin/java -Xloggc:gc -Xmx256m -server -ea -classpath ${AMFICOMCLASSPATH}:${ORACLECLASSPATH}:${TROVE4JCLASSPATH} com.syrus.AMFICOM.arserver.AdministrationResourceServer"
