/*
 * $Id: IdentifierTestCase.java,v 1.1 2005/03/04 19:13:37 bass Exp $
 *
...
public class IdentifierTestCase extends TestCase {
	public static void main(String[] args) {
		junit.awtui.TestRunner.run(IdentifierTestCase.class);
	}

	public final void testHashCode() {
		long minor = 1L;
		Identifier id1 = new Identifier(ObjectEntities.ANALYSIS_ENTITY + Identifier.SEPARATOR + minor);
		Identifier id2 = new Identifier(ObjectEntities.ANALYSIS_ENTITY_CODE, minor);
	...
	public final void testIdentifierImplString() {
		long minor = 1L;
		Identifier id = new Identifier(ObjectEntities.ANALYSIS_ENTITY + Identifier.SEPARATOR + minor);
	...
	public final void testIdentifierImplshortlong() {
		long minor = 1L;
		Identifier id = new Identifier(ObjectEntities.ANALYSIS_ENTITY_CODE, minor);
		System.err.println(id);
	}

	public final void testCompareTo() {
		long minor = 1L;
		Identifier id1 = new Identifier(ObjectEntities.MEASUREMENT_MIN_ENTITY_CODE, minor);
		Identifier id2 = new Identifier(ObjectEntities.CONFIGURATION_MIN_ENTITY_CODE, minor);
		Identifier id3 = new Identifier(ObjectEntities.CONFIGURATION_MIN_ENTITY_CODE, ++minor);
