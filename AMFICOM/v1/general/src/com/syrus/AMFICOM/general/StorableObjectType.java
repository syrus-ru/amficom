/*-
 * $Id: StorableObjectType.java,v 1.37.2.1.2.1 2006/04/13 14:07:11 arseniy Exp $
 *
...
/**
 * @version $Revision: 1.37.2.1.2.1 $, $Date: 2006/04/13 14:07:11 $
...
public abstract class StorableObjectType extends StorableObject {
	...
	/**
	 * Кодовое имя. Уникально среди объектов одной сущности.
	 */
