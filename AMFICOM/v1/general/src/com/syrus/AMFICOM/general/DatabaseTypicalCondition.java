/*
 * $Id: DatabaseTypicalCondition.java,v 1.19.4.1.2.1 2006/04/18 17:06:09 arseniy Exp $
 *
 ...
 * </pre>
 *
 * @version $Revision: 1.19.4.1.2.1 $, $Date: 2006/04/18 17:06:09 $
...
public final class DatabaseTypicalCondition extends AbstractDatabaseTypicalCondition {
	...
	DatabaseTypicalCondition(final TypicalCondition condition) {
		super(condition);
		...
		try {
			...
			Log.debugMessage(DATABASE_TYPICAL_CONDITION_INIT + "Class " + className + " not found on the classpath",
					Level.WARNING);
		} catch (ClassCastException cce) {
			Log.debugMessage(DATABASE_TYPICAL_CONDITION_INIT
