	...
	extends HttpServlet
{
			...
			HttpServletResponse resp)
	{
		...
		//¬ текущей идеологии сначала надо забрать изображение,
...
//			setState(STATE_IDLE);
	...
	/**
	 * ¬ыдел€ет имена параметров и их значений в строке запроса и помещает
	 * их в структуру HashMap 
	 * @param queryString строка запроса
	 * @return HashMap с парами "им€ параметра - значение"
	 */
...
//	/**
//	 * «аписывает сообщени€ в конец файла "mcs_log.txt", указыва€ дату их записи.
//	 * ‘айл расположен в $MapXtremeHome/bin.
//	 */
