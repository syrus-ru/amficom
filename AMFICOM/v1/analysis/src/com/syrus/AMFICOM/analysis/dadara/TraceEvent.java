...
/**
 * Сейчас используется только для хранения overallStats
 * @author $Author: saa $
 * @version $Revision: 1.14 $, $Date: 2005/10/17 14:20:09 $
 * @module
 */
...
//	private double loss = 0; // свойство определено для лин.уч., коннекторов, сварок и н/ид; не определено для начала и конца волокна
...
//	}
	...
	public TraceEvent(int last_point) {
		this.last_point = last_point;
	}
...
//	}
	...
	public double overallStatsDD98pct() {
		return this.data[3] - this.data[0];
	}
	public double overallStatsDDRMS() {
		return this.data[4] - this.data[0];
	}
