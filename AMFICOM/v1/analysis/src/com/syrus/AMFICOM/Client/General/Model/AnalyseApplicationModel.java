...
public class AnalyseApplicationModel extends ApplicationModel {
	...
	public AnalyseApplicationModel() {
		...
		add("menuTraceClose");
//		add("menuTraceDownloadEtalon"); // νες
//		add("menuTraceCloseEtalon"); // νες
//		add("menuTraceReferenceClose"); // νες
		add("menuTraceSavePES"); // δΰ

		add("menuTestSetup");
		add("menuCreateTestSetup");
		add("menuSaveTestSetup");
		add("menuSaveTestSetupAs");
//		add("menuLoadTestSetup"); // νες
//		add("menuAnalyseUpload"); // νες
//		add("menuNetStudy"); // νες

//		add("menuOptions"); // νες
//		add("menuOptionsColor"); // νες
