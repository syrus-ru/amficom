...
public class ArchiveTreeModel extends ObjectResourceTreeModel
{
	...
	public List getChildNodes(ObjectResourceTreeNode node) {
		...
		if (nodeObject instanceof String) {
			...
			if (s.equals("root")) {
				list.add(new ObjectResourceTreeNode("measurements", "Измерения", true));
				list.add(new ObjectResourceTreeNode("models", "Модели", true));
				...
				list.add(new ObjectResourceTreeNode("calculated", "Расчетные", true));
				list.add(new ObjectResourceTreeNode("predicted", "Прогнозируемые", true));
			...
			if (str.equals("measurements")) {
				list.add(new ObjectResourceTreeNode("measurementsetups", "По шаблонам", true));
				list.add(new ObjectResourceTreeNode("dates", "По дате", true));
				list.add(new ObjectResourceTreeNode("alarms", "По сигналам тревоги", true));
