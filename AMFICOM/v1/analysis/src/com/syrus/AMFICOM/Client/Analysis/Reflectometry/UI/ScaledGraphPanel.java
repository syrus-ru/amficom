...
{
	//показывает откуда отсчитывается и куда направлена ось Y
	...
	protected int cell_w = 40; // ширина ячейки сетки в пикселах
	protected int cell_h = 40; // высота ячейки сетки в пикселах
