/*-
 * $Id: ResultChildrenFactory.java,v 1.23.2.1 2006/04/06 13:01:43 saa Exp $
 *
...
import com.syrus.AMFICOM.measurement.ActionWrapper;
...
/**
 * @author $Author: saa $
 * @version $Revision: 1.23.2.1 $, $Date: 2006/04/06 13:01:43 $
 * @module analysis
 */
...
//				item2.setIcon(UIManager.getIcon(ResourceKeys.ICON_MINI_FOLDER));
				...
				final StorableObjectCondition measurementStatusCondition =
					new TypicalCondition(ActionStatus.ACTION_STATUS_COMPLETED,
							OperationSort.OPERATION_EQUALS,
							ObjectEntities.MEASUREMENT_CODE,
							ActionWrapper.COLUMN_STATUS);
