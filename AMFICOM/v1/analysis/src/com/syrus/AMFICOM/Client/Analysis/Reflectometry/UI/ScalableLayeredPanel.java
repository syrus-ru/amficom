...
public class ScalableLayeredPanel extends ResizableLayeredPanel
{
	...
	/**
	 * Добавляет SimpleGraphPanel на LayeredPanel. Если добавляемая панель
	 * instanceof ActiveReflectogramPanel, то она добавляется на самый верх,
	 * чтобы первой получать события от мыши.
	 * @param panel
	 */
