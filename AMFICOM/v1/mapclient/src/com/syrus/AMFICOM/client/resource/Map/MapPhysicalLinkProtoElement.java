...
public class MapPhysicalLinkProtoElement 
		extends MapPhysicalLinkElement
		implements Serializable
{
	private static final long serialVersionUID = 01L;
	static final public String typ = "maplinkproto";

	public MapLinkProtoElement_Transferable transferable;

	long modified;

	public String domain_id = "";

	public Vector cabletype_ids = new Vector();

	public MapPhysicalLinkProtoElement()
	{
	}
	
	public MapPhysicalLinkProtoElement( MapLinkProtoElement_Transferable transferable)
	{
	...
	public void setLocalFromTransferable()
	{
		...
		this.cabletype_ids = new Vector();
		for (int i = 0; i < transferable.cable_type_ids.length; i++)
			this.cabletype_ids.add(transferable.cable_type_ids[i]);
	}
...
//этот класс используетс€ дл€ отпрвки данных в базу
	public void setTransferableFromLocal()
	{
		...
		transferable.cable_type_ids = new String[ this.cabletype_ids.size()];
		for (i = 0; i < transferable.cable_type_ids.length; i++)
			transferable.cable_type_ids[i] = (String) this.cabletype_ids.get(i);
	}
			...
			throws IOException, ClassNotFoundException
	{
		...
		cabletype_ids = (Vector )in.readObject();
