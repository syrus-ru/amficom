...
//A0A
public class MapKISNodeElementModel extends MapNodeElementModel
{
	MapKISNodeElement node;

	public MapKISNodeElementModel(MapKISNodeElement node)
	{
		super(node);
		this.node = node;
	}
