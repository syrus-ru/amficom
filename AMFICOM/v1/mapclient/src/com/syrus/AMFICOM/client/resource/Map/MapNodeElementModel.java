...
//A0A
public class MapNodeElementModel extends ObjectResourceModel
{
	protected MapNodeElement obj;

	MapNodeElementModel(MapNodeElement obj)
	{
		this.obj = obj;
	}
	...
	public Component getPropertyRenderer(String col_id)
	{
		...
		if(ea == null)
//			return getColumnRenderer(obj, col_id);
			return null;
	...
	public Component getPropertyEditor(String col_id)
	{
		ElementAttribute ea = (ElementAttribute )obj.attributes.get(col_id);
		if(ea == null)
//			return getColumnEditor(obj, col_id);
			return null;
		return ea.getEditor();
	}
