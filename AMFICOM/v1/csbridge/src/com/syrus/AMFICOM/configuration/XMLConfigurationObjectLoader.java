/*
 * $Id: XMLConfigurationObjectLoader.java,v 1.1 2005/04/27 13:42:22 arseniy Exp $
 *
...
public final class XMLConfigurationObjectLoader extends XMLObjectLoader implements ConfigurationObjectLoader {
	...
	private void saveStorableObject(StorableObject storableObject, boolean force) throws ApplicationException {
		this.configurationXML.updateObject(storableObject, force);
	}
