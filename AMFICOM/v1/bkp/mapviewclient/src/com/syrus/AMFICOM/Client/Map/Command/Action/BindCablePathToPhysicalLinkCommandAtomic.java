/**
 * $Id: BindCablePathToPhysicalLinkCommandAtomic.java,v 1.1 2004/10/09 13:33:40 krupenn Exp $
 *
 * Syrus Systems
 ...
 * @see
 */
public class BindCablePathToPhysicalLinkCommandAtomic extends MapActionCommandBundle
{
	/**
	 * Удаляемый узел
	 */
	...
	public BindCablePathToPhysicalLinkCommandAtomic(MapCablePathElement path, MapPhysicalLinkElement link)
	{
		this.path = path;
		this.link = link;
	}
	...
	public void execute()
	{
		...
		map = mapView.getMap();
		link.getBinding().add(path.getSchemeCableLink());
/*		
