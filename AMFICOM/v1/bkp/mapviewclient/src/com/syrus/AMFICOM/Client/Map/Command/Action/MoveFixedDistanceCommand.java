/**
 * $Id: MoveFixedDistanceCommand.java,v 1.2 2004/11/16 17:31:17 krupenn Exp $
 *
 * Syrus Systems
 ...
 * 
 * 
 * @version $Revision: 1.2 $, $Date: 2004/11/16 17:31:17 $
 * @module
...
public class MoveFixedDistanceCommand extends MoveSelectionCommandBundle
{
	...
	public MoveFixedDistanceCommand(Point point, MapNodeElement fixedNode, MapNodeElement movedNode)
	{
		...
		fixedPoint = fixedNode.getAnchor();

		double fx = fixedNode.getAnchor().x;
		double fy = fixedNode.getAnchor().y;
		double mx = movedNode.getAnchor().x;
		double my = movedNode.getAnchor().y;
	...
	public void setLogicalNetLayer(LogicalNetLayer logicalNetLayer)
	{
		...
		fp = logicalNetLayer.convertMapToScreen(fixedNode.getAnchor());
		Point ep = logicalNetLayer.convertMapToScreen(movedNode.getAnchor());
	...
	protected void setShift()
	{
		...
		Point2D.Double tp = logicalNetLayer.convertScreenToMap(targetp1);
