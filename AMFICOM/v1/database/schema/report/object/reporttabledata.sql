--$Id: reporttabledata.sql,v 1.3.2.1 2006/02/14 10:32:49 arseniy Exp $
...
COMMENT ON TABLE ReportTableData IS '$Id: reporttabledata.sql,v 1.3.2.1 2006/02/14 10:32:49 arseniy Exp $';
