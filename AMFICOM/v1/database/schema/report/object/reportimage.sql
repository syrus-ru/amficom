--$Id: reportimage.sql,v 1.4.2.1 2006/02/14 10:32:49 arseniy Exp $
...
COMMENT ON TABLE ReportImage IS '$Id: reportimage.sql,v 1.4.2.1 2006/02/14 10:32:49 arseniy Exp $';
