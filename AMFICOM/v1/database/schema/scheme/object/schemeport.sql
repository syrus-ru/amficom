-- $Id: schemeport.sql,v 1.1 2005/02/10 08:47:55 bass Exp $
...
--
	...
	CONSTRAINT schemeport_msrmnt_port_type_fk FOREIGN KEY(measurement_port_type_id)
...
--
	...
	CONSTRAINT schemeport_msrmnt_port_chk CHECK
