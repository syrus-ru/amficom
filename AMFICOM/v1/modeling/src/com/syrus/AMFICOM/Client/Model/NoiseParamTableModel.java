/*-
 * $Id: NoiseParamTableModel.java,v 1.1 2005/12/07 14:31:49 stas Exp $
 *
...
public class NoiseParamTableModel extends AbstractTableModel {
...
class NoiseModelParamsTableEditor extends DefaultCellEditor {
	Object editor;
	NoiseParamTableModel model;

	public NoiseModelParamsTableEditor(NoiseParamTableModel model) {
...
class NoiseModelParamsTableRenderer extends DefaultTableCellRenderer {
	private static final long serialVersionUID = 6245907018616151050L;
	NoiseParamTableModel model;
	public NoiseModelParamsTableRenderer(NoiseParamTableModel model) {
		this.model = model;
	}
