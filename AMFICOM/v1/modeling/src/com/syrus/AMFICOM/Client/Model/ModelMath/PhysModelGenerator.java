...
public class PhysModelGenerator {
	SchemePath path;
	...
	public PhysModelGenerator(SchemePath path,
		int waveLength,
		double defConnectorLoss,
		double defWeldLoss,
		double defReflect,
...
*/
	...
	public List createModelingEvents() throws ApplicationException
	{
		reflectoElements.clear();
