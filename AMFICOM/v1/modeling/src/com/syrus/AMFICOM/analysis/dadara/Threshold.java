...
public class Threshold
{
	...
	public double[] getThresholds (int key)
	{
		return new double[]
		{
			MathRefModel.round_3(dA[key]),
			MathRefModel.round_3(dC[key]),
			MathRefModel.round_3(dX[key]),
			MathRefModel.round_3(dL[key])
		};
	}
	...
	public Double[] getThresholdsObject (int key)
	{
		return new Double[]
		{
			new Double(MathRefModel.round_3(dA[key])),
			new Double(MathRefModel.round_3(dC[key])),
			new Double(MathRefModel.round_3(dX[key])),
			new Double(MathRefModel.round_3(dL[key]))
		};
	}
