/*
 * $Id: UserTraceMessagePanel.java,v 1.1 2004/06/22 09:57:10 bass Exp $
 *
 ...
 */
final class UserTraceMessagePanel extends JPanel implements LogWriter
{
	...
	static
	{
		try
		{
			fos = new FileOutputStream("user.log", true);
	...
	private void jbInit()
	{
		setName("Трассировка пользователей");
...
//		logText.setWrapStyleWord(true);
	...
	public void log(String s)
	{
		...
		logText.append(s);
		logText.append("\n");
		System.out.println("UserTracer: " + s);
