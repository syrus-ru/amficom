/*
 * $Id: EventTraceMessagePanel.java,v 1.1 2004/06/22 09:57:10 bass Exp $
 *
 ...
 */
final class EventTraceMessagePanel extends JPanel implements LogWriter
{
	...
	static
	{
		try
		{
			fos = new FileOutputStream("eventtrace.log", true);
...
//		logText.setWrapStyleWord(true);
	...
	public void log(String s)
	{
		...
		logText.append(s);
		logText.append("\n");
		System.out.println("EventTracer: " + s);
