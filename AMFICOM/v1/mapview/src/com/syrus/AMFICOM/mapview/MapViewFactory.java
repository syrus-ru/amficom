/*-
 * $Id: MapViewFactory.java,v 1.4 2005/06/24 10:41:47 bass Exp $
 *
 ...
 * @author $Author: bass $
 * @version $Revision: 1.4 $, $Date: 2005/06/24 10:41:47 $
 * @module mapview_v1
 */
final class MapViewFactory extends StorableObjectFactory {
	...
	protected StorableObject newInstance(final IDLEntity transferable) throws CreateObjectException {
		return new MapView((IdlMapView) transferable);
	}
	...
	protected Identifier getId(final IDLEntity transferable) {
		return new Identifier(((IdlMapView) transferable).header.id);
	}
