/*
 * $Id: CMServerServantManager.java,v 1.2 2005/05/04 13:51:36 arseniy Exp $
 * 
...
/**
 * @version $Revision: 1.2 $, $Date: 2005/05/04 13:51:36 $
...
final class CMServerServantManager extends RunnableVerifiedConnectionManager implements BaseConnectionManager {
	...
	public CMServerServantManager(CORBAServer corbaServer,
	...
	public static CMServerServantManager createAndStart(String serverHostName) throws CommunicationException {
		...
		CMServerServantManager cmServerServantManager = new CMServerServantManager(corbaServer,
