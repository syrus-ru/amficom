/*
 * $Id: CMConfigurationReceive.java,v 1.15 2005/02/24 15:21:32 arseniy Exp $
 *
...
/**
 * @version $Revision: 1.15 $, $Date: 2005/02/24 15:21:32 $
...
public abstract class CMConfigurationReceive extends CMAdministrationReceive {
	...
	public StorableObject_Transferable receiveCableThreadType(CableThreadType_Transferable cableThreadType_Transferable,
		...
		try {
			...
			database.update(cableThreadType, new Identifier(accessIdentifier.user_id), force ? StorableObjectDatabase.UPDATE_FORCE : StorableObjectDatabase.UPDATE_CHECK);
