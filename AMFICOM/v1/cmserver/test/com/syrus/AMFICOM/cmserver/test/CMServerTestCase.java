/*
 * $Id: CMServerTestCase.java,v 1.8 2004/09/23 07:39:37 max Exp $
 *
...
/**
 * @version $Revision: 1.8 $, $Date: 2004/09/23 07:39:37 $
 * @author $Author: max $
 * @module module
 */
...
//      Checking method transmitDomains(null , acc)
        ...
        Domain_Transferable[] domain_Transferables = server
                .transmitDomains(identifier_Transferables,
                accessIdentifier_Transferable);
        long time1 = System.currentTimeMillis();
        System.out.println("1. transmit "
                + domain_Transferables.length + " identifier_Transferabl(es) for "
                + (time1 - time0) + " ms");
...
//      Checking method transmitDomain(Id_Trans , acc)        
        ...
        Domain_Transferable domain_Transferable2 = server
                .transmitDomain(id_Tf,
                accessIdentifier_Transferable);
        long time3 = System.currentTimeMillis();
        System.out.println("2. transmit "
                + "Domain_Transferables" + "  for "
                + (time3 - time2) + " ms");
//      Checking method transmitDomain(Id_Trans[] , acc)        
        ...
        Domain_Transferable[] domain_Transferables3 = server
                .transmitDomains(identifier_Transferables2 ,
                accessIdentifier_Transferable);
        long time5 = System.currentTimeMillis();
        System.out.println("3. transmit "
                + identifier_Transferables2.length + "  for "
                + (time5 - time4) + " ms");
	}  
...
//      Checking method transmitAnalysisTypes(null , acc)
        ...
        long time0 = System.currentTimeMillis();
        analysisType_Transferables = server
				.transmitAnalysisTypes(identifier_Transferables,
				accessIdentifier_Transferable);
		long time1 = System.currentTimeMillis();
		System.out.println("1. transmit "
				+ analysisType_Transferables.length + " identifier_Transferabl(es) for "
				+ (time1 - time0) + " ms");
...
//      Checking method transmitAnalysisType(Id_Trans , acc)        
        ...
        AnalysisType_Transferable analysisType_Transferable2 = server
                .transmitAnalysisType(id_Tf,
                accessIdentifier_Transferable);
        long time3 = System.currentTimeMillis();
        System.out.println("2. transmit "
                + "AnalysisType_Transferables" + "  for "
                + (time3 - time2) + " ms");
//      Checking method transmitAnalysisType(Id_Trans[] , acc)        
        Identifier_Transferable[] identifier_Transferables2 = new Identifier_Transferable[2];
        identifier_Transferables2[0] = id_Tf;
        ...
        AnalysisType_Transferable[] analysisType_Transferables3 = server
                .transmitAnalysisTypes(identifier_Transferables2 ,
                accessIdentifier_Transferable);
        long time5 = System.currentTimeMillis();
        System.out.println("3. transmit "
                + identifier_Transferables2.length + "  for "
...
//      Checking method transmitEvaluationTypes(null , acc)
        ...
        EvaluationType_Transferable[] evaluationType_Transferables = server
                .transmitEvaluationTypes(identifier_Transferables,
                accessIdentifier_Transferable);
        long time1 = System.currentTimeMillis();
        System.out.println("1. transmit "
                + evaluationType_Transferables.length + " identifier_Transferabl(es) for "
                + (time1 - time0) + " ms");
...
//      Checking method transmitEvaluationType(Id_Trans , acc)        
        ...
        EvaluationType_Transferable evaluationType_Transferable2 = server
                .transmitEvaluationType(id_Tf,
                accessIdentifier_Transferable);
        long time3 = System.currentTimeMillis();
        System.out.println("2. transmit "
                + "EvaluationType_Transferables" + "  for "
                + (time3 - time2) + " ms");
//      Checking method transmitEvaluationType(Id_Trans[] , acc)        
        Identifier_Transferable[] identifier_Transferables2 = new Identifier_Transferable[2];
        identifier_Transferables2[0] = id_Tf;
        ...
        EvaluationType_Transferable[] evaluationType_Transferables3 = server
                .transmitEvaluationTypes(identifier_Transferables2 ,
                accessIdentifier_Transferable);
        long time5 = System.currentTimeMillis();
        System.out.println("3. transmit "
                + identifier_Transferables2.length + "  for "
...
//      Checking method transmitMeasurementTypes(null , acc)
        ...
        long time1 = System.currentTimeMillis();
        System.out.println("1. transmit "
                + measurementType_Transferables.length + " identifier_Transferabl(es) for "
                + (time1 - time0) + " ms");
...
//      Checking method transmitMeasurementType(Id_Trans , acc)        
        ...
        MeasurementType_Transferable measurementType_Transferable2 = server
                .transmitMeasurementType(id_Tf,
                accessIdentifier_Transferable);
        long time3 = System.currentTimeMillis();
        System.out.println("2. transmit "
                + "MeasurementType_Transferables" + "  for "
                + (time3 - time2) + " ms");
//      Checking method transmitMeasurementType(Id_Trans[] , acc)        
        Identifier_Transferable[] identifier_Transferables2 = new Identifier_Transferable[2];
        identifier_Transferables2[0] = id_Tf;
        ...
        MeasurementType_Transferable[] measurementType_Transferables3 = server
                .transmitMeasurementTypes(identifier_Transferables2 ,
                accessIdentifier_Transferable);
        long time5 = System.currentTimeMillis();
        System.out.println("3. transmit "
                + identifier_Transferables2.length + "  for "
...
//      Checking method transmitMeasurements(null , acc)
        ...
        Measurement_Transferable[] measurement_Transferables = server
                .transmitMeasurements(identifier_Transferables,
                accessIdentifier_Transferable);
        long time1 = System.currentTimeMillis();
        System.out.println("1. transmit "
                + measurement_Transferables.length + " identifier_Transferabl(es) for "
                + (time1 - time0) + " ms");
...
//      Checking method transmitMeasurement(Id_Trans , acc)        
        ...
        Measurement_Transferable measurement_Transferable2 = server
                .transmitMeasurement(id_Tf,
                accessIdentifier_Transferable);
        long time3 = System.currentTimeMillis();
        System.out.println("2. transmit "
                + "Measurement_Transferables" + "  for "
                + (time3 - time2) + " ms");
//      Checking method transmitMeasurement(Id_Trans[] , acc)        
        Identifier_Transferable[] identifier_Transferables2 = new Identifier_Transferable[2];
        identifier_Transferables2[0] = id_Tf;
        ...
        Measurement_Transferable[] measurement_Transferables3 = server
                .transmitMeasurements(identifier_Transferables2 ,
                accessIdentifier_Transferable);
        long time5 = System.currentTimeMillis();
        System.out.println("3. transmit "
                + identifier_Transferables2.length + "  for "
...
//      Checking method transmitMonitoredElements(null , acc)
        ...
        long time1 = System.currentTimeMillis();
        System.out.println("1. transmit "
                + monitoredElement_Transferables.length + " identifier_Transferabl(es) for "
                + (time1 - time0) + " ms");
...
//      Checking method transmitMonitoredElement(Id_Trans , acc)        
        ...
        MonitoredElement_Transferable monitoredElement_Transferable2 = server
                .transmitMonitoredElement(id_Tf,
                accessIdentifier_Transferable);
        long time3 = System.currentTimeMillis();
        System.out.println("2. transmit "
                + "MonitoredElement_Transferables" + "  for "
                + (time3 - time2) + " ms");
//      Checking method transmitMonitoredElement(Id_Trans[] , acc)        
        Identifier_Transferable[] identifier_Transferables2 = new Identifier_Transferable[2];
        identifier_Transferables2[0] = id_Tf;
        ...
        MonitoredElement_Transferable[] monitoredElement_Transferables3 = server
                .transmitMonitoredElements(identifier_Transferables2 ,
                accessIdentifier_Transferable);
        long time5 = System.currentTimeMillis();
        System.out.println("3. transmit "
                + identifier_Transferables2.length + "  for "
...
//      Checking method transmitParameterTypes(null , acc)
        ...
        long time1 = System.currentTimeMillis();
        System.out.println("1. transmit "
                + parameterType_Transferables.length + " identifier_Transferabl(es) for "
                + (time1 - time0) + " ms");
...
//      Checking method transmitParameterType(Id_Trans , acc)        
        ...
        ParameterType_Transferable ParameterType_Transferable2 = server
                .transmitParameterType(id_Tf,
                accessIdentifier_Transferable);
        long time3 = System.currentTimeMillis();
        System.out.println("2. transmit "
                + "ParameterType_Transferables" + "  for "
                + (time3 - time2) + " ms");
//      Checking method transmitParameterType(Id_Trans[] , acc)        
        Identifier_Transferable[] identifier_Transferables2 = new Identifier_Transferable[2];
        identifier_Transferables2[0] = id_Tf;
        ...
        ParameterType_Transferable[] parameterType_Transferables3 = server
                .transmitParameterTypes(identifier_Transferables2 ,
                accessIdentifier_Transferable);
        long time5 = System.currentTimeMillis();
        System.out.println("3. transmit "
                + identifier_Transferables2.length + "  for "
...
//      Checking method transmitResults(null , acc)
        ...
        Identifier_Transferable identifier_Transferables[] = new Identifier_Transferable[0];                 
        long time0 = System.currentTimeMillis();
        Result_Transferable[] result_Transferables = server
                .transmitResults(identifier_Transferables,
                accessIdentifier_Transferable);
        long time1 = System.currentTimeMillis();
        System.out.println("1. transmit "
                + result_Transferables.length + " identifier_Transferabl(es) for "
                + (time1 - time0) + " ms");
...
//      Checking method transmitResult(Id_Trans , acc)        
        if(result_Transferables.length > 0) {
            ...
            Result_Transferable result_Transferable2 = server
                    .transmitResult(id_Tf,
                    accessIdentifier_Transferable);
            long time3 = System.currentTimeMillis();
            System.out.println("2. transmit "
                    + "Result_Transferables" + "  for "
                    + (time3 - time2) + " ms");
    //      Checking method transmitResult(Id_Trans[] , acc)        
            Identifier_Transferable[] identifier_Transferables2 = new Identifier_Transferable[2];
            identifier_Transferables2[0] = id_Tf;
            ...
            Result_Transferable[] result_Transferables3 = server
                    .transmitResults(identifier_Transferables2 ,
                    accessIdentifier_Transferable);
            long time5 = System.currentTimeMillis();
            System.out.println("3. transmit "
                    + identifier_Transferables2.length + "  for "
...
//      Checking method transmitTests(null , acc)
        ...
        Identifier_Transferable identifier_Transferables[] = new Identifier_Transferable[0];                 
        long time0 = System.currentTimeMillis();
        Test_Transferable[] Test_Transferables = server
                .transmitTests(identifier_Transferables,
                accessIdentifier_Transferable);
        long time1 = System.currentTimeMillis();
        System.out.println("1. transmit "
                + Test_Transferables.length + " identifier_Transferabl(es) for "
                + (time1 - time0) + " ms");
...
//      Checking method transmitTest(Id_Trans , acc)        
        ...
        long time2 = System.currentTimeMillis();
        Test_Transferable test_Transferable2 = server
                .transmitTest(id_Tf,
                accessIdentifier_Transferable);
        long time3 = System.currentTimeMillis();
        System.out.println("2. transmit "
                + "Test_Transferables" + "  for "
                + (time3 - time2) + " ms");
//      Checking method transmitTest(Id_Trans[] , acc)        
        Identifier_Transferable[] identifier_Transferables2 = new Identifier_Transferable[2];
        identifier_Transferables2[0] = id_Tf;
        identifier_Transferables2[1] = id_Tf;
        long time4 = System.currentTimeMillis();
        Test_Transferable[] test_Transferables3 = server
                .transmitTests(identifier_Transferables2 ,
                accessIdentifier_Transferable);
        long time5 = System.currentTimeMillis();
        System.out.println("3. transmit "
                + identifier_Transferables2.length + "  for "
...
//      Checking method transmitSets(null , acc)
        ...
        Identifier_Transferable identifier_Transferables[] = new Identifier_Transferable[0];                 
        long time0 = System.currentTimeMillis();
        Set_Transferable[] set_Transferables = server
                .transmitSets(identifier_Transferables,
                accessIdentifier_Transferable);
        long time1 = System.currentTimeMillis();
        System.out.println("1. transmit "
                + set_Transferables.length + " identifier_Transferabl(es) for "
                + (time1 - time0) + " ms");
...
//      Checking method transmitSet(Id_Trans , acc)        
        ...
        long time2 = System.currentTimeMillis();
        Set_Transferable set_Transferable2 = server
                .transmitSet(id_Tf,
                accessIdentifier_Transferable);
        long time3 = System.currentTimeMillis();
        System.out.println("2. transmit "
                + "Set_Transferables" + "  for "
                + (time3 - time2) + " ms");
//      Checking method transmitSet(Id_Trans[] , acc)        
        Identifier_Transferable[] identifier_Transferables2 = new Identifier_Transferable[2];
        identifier_Transferables2[0] = id_Tf;
        identifier_Transferables2[1] = id_Tf;
        long time4 = System.currentTimeMillis();
        Set_Transferable[] set_Transferables3 = server
                .transmitSets(identifier_Transferables2 ,
                accessIdentifier_Transferable);
        long time5 = System.currentTimeMillis();
        System.out.println("3. transmit "
                + identifier_Transferables2.length + "  for "
