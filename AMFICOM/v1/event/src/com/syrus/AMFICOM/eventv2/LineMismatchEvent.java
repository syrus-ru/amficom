/*-
 * $Id: LineMismatchEvent.java,v 1.3 2005/10/10 09:10:02 bass Exp $
 *
 ...
 * @author $Author: bass $
 * @version $Revision: 1.3 $, $Date: 2005/10/10 09:10:02 $
 * @module event
 */
public interface LineMismatchEvent extends Event {
	/**
