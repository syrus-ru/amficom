/*-
 * $Id: DefaultReflectogramMismatchEvent.java,v 1.15.2.1 2006/03/28 12:11:57 arseniy Exp $
 *
 ...
 * @version $Revision: 1.15.2.1 $, $Date: 2006/03/28 12:11:57 $
 * @module event
 */
public final class DefaultReflectogramMismatchEvent extends
	...
	private DefaultReflectogramMismatchEvent(final Identifier id,
		...
		if (resultIdMajor != ANALYSISRESULTPARAMETER_CODE) {
