/*-
 * $Id: EventSourceFactory.java,v 1.1 2005/05/25 13:01:02 bass Exp $
 *
...
final class EventSourceFactory extends StorableObjectFactory {
	...
	protected StorableObject newInstance(final IDLEntity transferable) throws CreateObjectException {
		return new EventSource((EventSource_Transferable) transferable);
	}
	...
	protected Identifier getId(final IDLEntity transferable) {
		return new Identifier(((EventSource_Transferable) transferable).header.id);
	}
}
