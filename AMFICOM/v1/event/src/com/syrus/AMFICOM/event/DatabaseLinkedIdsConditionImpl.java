/*-
 * $Id: DatabaseLinkedIdsConditionImpl.java,v 1.4 2006/07/03 13:03:33 bass Exp $
 *
 ...
 * @author $Author: bass $
 * @version $Revision: 1.4 $, $Date: 2006/07/03 13:03:33 $
 * @module event
 */
	...
	public String getSQLQuery() throws IllegalObjectEntityException {
		...
		case LINEMISMATCHEVENT_CODE:
			...
			case REFLECTOGRAMMISMATCHEVENT_CODE:
				return this.getQuery(LineMismatchEventWrapper.COLUMN_REFLECTOGRAM_MISMATCH_EVENT_ID);
