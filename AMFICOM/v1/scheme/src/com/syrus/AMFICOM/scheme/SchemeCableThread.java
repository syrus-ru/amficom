/*-
 * $Id: SchemeCableThread.java,v 1.113.2.3 2006/03/17 12:25:11 arseniy Exp $
 *
 ...
 * @version $Revision: 1.113.2.3 $, $Date: 2006/03/17 12:25:11 $
 * @module scheme
 */
...
//					"This scheme cable thread is in no way connected to the scheme device specified.");
	...
	public IdlSchemeCableThread getIdlTransferable(final ORB orb) {
		...
		return IdlSchemeCableThreadHelper.init(orb,
				...
				this.linkId.getIdlTransferable(),
				this.sourceSchemePortId.getIdlTransferable(),
				this.targetSchemePortId.getIdlTransferable(),
