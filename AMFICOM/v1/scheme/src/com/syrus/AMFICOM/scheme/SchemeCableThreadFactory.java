/*-
 * $Id: SchemeCableThreadFactory.java,v 1.4 2005/06/24 14:13:38 bass Exp $
 *
...
final class SchemeCableThreadFactory extends StorableObjectFactory {
	...
	protected StorableObject newInstance(final IDLEntity transferable) throws CreateObjectException {
		return new SchemeCableThread((IdlSchemeCableThread) transferable);
	}
	...
	protected Identifier getId(final IDLEntity transferable) {
		return new Identifier(((IdlSchemeCableThread) transferable).header.id);
	}
