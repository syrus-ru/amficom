/*
 * $Id: FilterGUITemp.java,v 1.1 2005/03/15 16:11:44 max Exp $
 *
 ...
 * @module misc
 */
public class FilterGUITemp extends JFrame {
	...
	public FilterGUITemp(ConditionWrapperTemp wrapper) {

		super();
		this.filter = new FilterTemp(wrapper, this);
		createFrame();
	...
	private void createFrame() {
		...
		JButton logicSchemeButton = 	new JButton(LOGIC_SCHEME_BUTTON);
		...
		this.filteredList = 			new JList(filter.getFilteredList());
		...
		JScrollPane conditionScroller =	new JScrollPane(this.conditionList);
		...
		logicSchemeButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				filter.showLogicalScheme();
			}			
		});
		...
		gbc.gridwidth = GridBagConstraints.REMAINDER;
		edditPanel.add(logicSchemeButton, gbc);
	...
	public void drawLinkedCondition(ListCondition listCondition) {
		this.linkedConditionList.setListData(listCondition.getLinkedNames());
	...
	private void changeKey() {
		this.filter.changeKey(getKeyIndex());
	}
	...
	private void removeCondition() {
		Object[] conditions = this.conditionList.getSelectedValues();
		this.filter.removeCondition(conditions);
	}
	...
	public void setListCondition(ListCondition listCondition) {
		listCondition.setLinkedIndex(this.linkedConditionList.getSelectedIndices());		
	}

	public void refreshCondition(Object[] conditions) {
		this.conditionList.setListData(conditions);
	}
}
