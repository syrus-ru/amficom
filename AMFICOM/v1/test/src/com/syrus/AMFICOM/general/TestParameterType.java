/*
 * $Id: TestParameterType.java,v 1.1.1.1 2005/02/15 09:37:20 cvsadmin Exp $ Copyright © 2004 Syrus Systems. Научно-технический центр. Проект:
 * АМФИКОМ.
 */
...
/**
 * @version $Revision: 1.1.1.1 $, $Date: 2005/02/15 09:37:20 $
