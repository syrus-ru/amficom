/*
 * $Id: CommonMeasurementTest.java,v 1.1.1.1 2005/04/22 16:12:48 cvsadmin Exp $
 * 
...
/**
 * @version $Revision: 1.1.1.1 $, $Date: 2005/04/22 16:12:48 $
...
public class CommonMeasurementTest extends TestCase {
	...
	public CommonMeasurementTest(String name) {
		super(name);
	}
