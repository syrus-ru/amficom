...
public class MeasurementPortTypeDisplayModel extends StubDisplayModel
{
	ApplicationContext aContext = new ApplicationContext();
	List cols = new ArrayList();

	public MeasurementPortTypeDisplayModel()
	{
		this(new ApplicationContext());
	}

	public MeasurementPortTypeDisplayModel(ApplicationContext aContext)
	{
		super();
	...
	{
		MeasurementPortType p = (MeasurementPortType)or;
		if(col_id.equals("id"))
