...
//			final Set kiss = StorableObjectPool.getStorableObjectsByCondition(lic, true);
	...
	private static void bootstrap() throws ApplicationException {
		...
		MCMSessionEnvironment.createInstance(setupServerHostName, new MeasurementControlModule.MCMLoginRestorer());
	...
	private static IdlMCM retrieveIdlMCM() throws ApplicationException {
		...
		try {
			idlStorableObjects = mServerRef.transmitStorableObjects(new IdlIdentifier[] { ID.getTransferable() },
