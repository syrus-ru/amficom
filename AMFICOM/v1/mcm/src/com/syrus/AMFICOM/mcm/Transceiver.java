...
public class Transceiver extends Thread {
	...
	public Transceiver(String kis_id_str) {
		this.taskFileName = "task" + kis_id_str;
    this.reportFileName = "report" + kis_id_str;
		this.kis_tick_time = ApplicationProperties.getInt("KISTickTime", KIS_TICK_TIME);
		this.running = true;
