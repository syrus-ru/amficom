...
public class SelectSolutionFrame extends JDialog
{
	...
	private void jbInit() throws Exception
	{
		...
		this.setTitle(LangModelReport.getString("label_chooseParams"));
		...
		schemeLabel.setText(LangModelReport.getString("label_scheme"));
		topologyLabel.setText(LangModelReport.getString("label_topology"));
		solutionLabel.setText(LangModelReport.getString("label_solution"));
