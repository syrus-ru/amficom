/*-
 * $Id: ReflectogramMismatchEventProcessor.java,v 1.1.1.1 2006/06/26 13:31:32 cvsadmin Exp $
 *
 ...
 * @version $Revision: 1.1.1.1 $, $Date: 2006/06/26 13:31:32 $
 * @module systemserver
 */
final class ReflectogramMismatchEventProcessor extends AbstractEventProcessor {
	...
	private static final String PHYSICAL_DISTANCE_TO = I18N.getString("LoginServer.NotificationEvent.PhysicalDistanceTo");

	private static final String END_OF = I18N.getString("LoginServer.NotificationEvent.EndOf");

	private static final String START_OF = I18N.getString("LoginServer.NotificationEvent.StartOf");

	private static final String PATH_ELEMENT_GENITIVE = I18N.getString("LoginServer.NotificationEvent.PathElementGenitive");

	private static final String PATH_ELEMENT = I18N.getString("LoginServer.NotificationEvent.PathElement");

	private static final String AFFECTED = I18N.getString("LoginServer.NotificationEvent.Affected");

	private static final String MISMATCH_LEVEL = I18N.getString("LoginServer.NotificationEvent.MismatchLevel");

	private static final String MISMATCH_CREATED = I18N.getString("LoginServer.NotificationEvent.MismatchCreated");


	private static final String METER_SINGULAR_NOMINATIVE = I18N.getString("LoginServer.NotificationEvent.MeterSingularNominative");

	private static final String METER_SINGULAR_GENITIVE = I18N.getString("LoginServer.NotificationEvent.MeterSingularGenitive");

	private static final String METER_PLURAL_GENITIVE = I18N.getString("LoginServer.NotificationEvent.MeterPluralGenitive");
	...
	public void processEvent(final Event<?> event) {
		...
		try {
			...
			final SystemServerServantManager servantManager = SystemServerServantManager.getInstance();
			servantManager.getEventServerReference().receiveEvents(new IdlEvent[] { lineMismatchEvent.getIdlTransferable(servantManager.getCORBAServer().getOrb()) });
