...
public interface AlarmReceiverMap {
     ...
     */
	boolean containsKey(AccessIdentity_Transferable key) throws AMFICOMRemoteException;
     ...
     */
	AMFICOMClient put(AccessIdentity_Transferable key, AMFICOMClient value) throws AMFICOMRemoteException;
     ...
     */
	AMFICOMClient remove(AccessIdentity_Transferable key) throws AMFICOMRemoteException;
}
