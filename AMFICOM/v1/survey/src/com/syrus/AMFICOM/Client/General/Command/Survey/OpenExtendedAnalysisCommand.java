...
public class OpenExtendedAnalysisCommand extends VoidCommand
{
	...
	public Object clone()
	{
		return new OpenExtendedAnalysisCommand(dispatcher, aContext, factory);
	}
	...
	public void execute()
	{
		if(!Checker.checkCommandByUserId(
				...
				Checker.enterExtendedAnalysisModul))
		{
			return;
		}
...
/*
		try
		{
			String st = "com.syrus.AMFICOM.Client.Analysis.Reflectometry.AnalyseExt";
