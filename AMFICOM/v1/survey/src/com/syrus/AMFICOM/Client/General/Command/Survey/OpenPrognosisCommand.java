...
public class OpenPrognosisCommand extends VoidCommand
{
	...
	public Object clone()
	{
		return new OpenPrognosisCommand(dispatcher, aContext, factory);
	}
...
/*
		try
		{
			String st = "com.syrus.AMFICOM.Client.Prediction.Prediction";
...
//		}
		catch(Exception e)
		{
			...
			dispatcher.notify(new StatusMessageEvent("Ошибка открытия модуля Prediction"));
		}
*/
	}
}
