...
public class AlarmsList extends ReportData
{
	public AlarmsList(ObjectsReport report,
		int divisionsNumber) throws CreateReportException
	{
		tableModel = new AlarmsListTableModel(divisionsNumber, report);
		columnModel = new AlarmsListTableColumnModel(divisionsNumber,
			tableModel.getColumnCount(),report);
	}
}

class AlarmsListTableColumnModel extends DividableTableColumnModel
{
	public AlarmsListTableColumnModel(
		int divisionsNumber,
		int columnCount,
...
class AlarmsListTableModel extends DividableTableModel
{
	int width = 0;
...
//	AMTReportTable reportTable = null;
  ObjectResourceTableModel model = null;
	...
	public AlarmsListTableModel(int divisionsNumber,
