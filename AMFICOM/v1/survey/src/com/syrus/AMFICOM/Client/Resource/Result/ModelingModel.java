...
public class ModelingModel extends ObjectResourceModel {
	...
	public String getColumnValue(String col_id) {
		String s = null;
		try {
			if (col_id.equals(ConstStorage.COLUMN_NAME_ID)) s = m.getId();
			if (col_id.equals(ConstStorage.COLUMN_NAME_NAME)) s = m.getName();
			if (col_id.equals(ConstStorage.COLUMN_NAME_MODIFIED))
					s = ConstStorage.SIMPLE_DATE_FORMAT.format(new Date(m
							.getModified()));
