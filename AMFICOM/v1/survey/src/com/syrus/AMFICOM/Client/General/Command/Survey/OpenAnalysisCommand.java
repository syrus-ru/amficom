...
public class OpenAnalysisCommand extends VoidCommand
{
	...
	public Object clone()
	{
		return new OpenAnalysisCommand(dispatcher, aContext, factory);
	}
...
/*
		try
		{
			String st = "com.syrus.AMFICOM.Client.Analysis.Reflectometry.Analyse";
...
//		}
		catch(Exception e)
		{
			...
			dispatcher.notify(new StatusMessageEvent("Ошибка открытия модуля Analyse"));
		}
*/
	}
}
