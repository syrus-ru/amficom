/*-
 * $Id: SchemeToolBar.java,v 1.1 2005/04/05 14:07:53 stas Exp $
 *
...
public class SchemeToolBar extends ElementsToolBar {
	...
	private static String[] buttons = new String[] { Constants.marqueeTool,
			...
			Constants.createTopLevelElementKey, Constants.groupSEKey,
	...
	protected SchemeToolBar(UgoTabbedPane sourcePane, UgoTabbedPane targetPane,
	...
	protected Map createGraphButtons() {
		...
		if (pane.getGraph().getMarqueeHandler() instanceof ShemeMarqueeHandler) {
			...
			bttns.put(Constants.groupSEKey, createToolButton(mh.gr2, btn_size, null,
			...
			bttns.put(Constants.TOP_LEVEL_SCHEME_MODE, createToolButton(
					mh.topModeButt, btn_size, null, "режим схематичного изображения",
					new ImageIcon(Toolkit.getDefaultToolkit().getImage(
							"images/scheme.gif")), new SetTopLevelModeAction(pane), true));
