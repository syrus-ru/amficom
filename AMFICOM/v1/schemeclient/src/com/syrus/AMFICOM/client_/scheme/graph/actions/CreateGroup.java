/*
 * $Id: CreateGroup.java,v 1.13 2005/09/28 11:37:50 stas Exp $
 *
...
/**
 * @author $Author: stas $
 * @version $Revision: 1.13 $, $Date: 2005/09/28 11:37:50 $
 * @module schemeclient
 */
...
public class CreateGroup extends AbstractAction {
	...
	public static DeviceGroup createElementsGroup(SchemeGraph graph, Object[] cells, SchemeElement element) {
		...
		try {
			element.setSchemeDevices(childSchemeDevices, false);
			element.setSchemeLinks(childSchemeLinks, false);
