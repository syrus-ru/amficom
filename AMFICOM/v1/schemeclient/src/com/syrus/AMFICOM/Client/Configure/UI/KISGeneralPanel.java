...
public class KISGeneralPanel extends GeneralPanel
{
	...
	public KISGeneralPanel(SchemeElement element)
	{
	 this();
...
//		this.add(saveButton, new XYConstraints(200, 380, -1, -1));
	...
	public void setObjectResource(ObjectResource or)
	{
		...
		if(element.kis != null)
		{
			descTextArea.setText(element.kis.description);
			typeBox.setSelected(element.kis.typeId);
	...
	public boolean modify()
	{
		try
		{
			...
			if (element.kis != null)
			{
				element.kis.description = descTextArea.getText();
				element.kis.typeId = (String) typeBox.getSelected();
				element.kis.mcmId = this.agentField.getText();
			}
		}
		catch (Exception ex)
		{
