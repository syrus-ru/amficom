...
class GraphSizeFrame extends JDialog
{
	...
	private void jbInit() throws Exception
	{
		...
		Dimension frameSize = new Dimension (270, 160);
		setSize(frameSize);
		...
		//fixComboBox.setPreferredSize(new Dimension(50, 10));
		...
		xPanel.add(wLabel, BorderLayout.WEST);
		xPanel.add(xsizeTextField, BorderLayout.CENTER);
		yPanel.add(hLabel, BorderLayout.WEST);
		yPanel.add(ysizeTextField, BorderLayout.CENTER);
