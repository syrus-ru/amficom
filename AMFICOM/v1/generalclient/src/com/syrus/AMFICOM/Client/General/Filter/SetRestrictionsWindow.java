...
public class SetRestrictionsWindow extends JInternalFrame
{
  ...
  private ObjectResourceFilterPane orfp = null;

  public ObjectResourceFilter orf = null;
    ...
    this.addInternalFrameListener(new javax.swing.event.InternalFrameAdapter()
    {
      public void internalFrameClosing(InternalFrameEvent e)
      {
        aContext.getDispatcher().notify(
          new OperationEvent(orf,0,com.syrus.AMFICOM.Client.General.Filter.ObjectResourceFilterPane.state_filterClosed));
