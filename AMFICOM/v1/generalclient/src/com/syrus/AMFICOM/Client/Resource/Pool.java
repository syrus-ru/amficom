...
public class Pool extends Object
{
	 ...
	 * obj_id public static void putName(String obj_type_id, String obj_id,
	 * String name) { // получаем список имен всех объектов типа obj_type_id
	 * Hashtable hash2 = (Hashtable )name_hash.get(obj_type_id); if(hash2 ==
	 * null) // если такого списка нет, то есть { // нет ни одного объекта
	 * данного hash2 = new Hashtable(); // типа, то создаем список имен
	 * name_hash.put(obj_type_id, hash2); // и заносим в хранилище // для имен
	 * объектов } // добавляем имя объекта hash2.put(obj_id, name); }
	 */
	...
	/*
	 * // получить список имен объектов типа obj_type_id public static Hashtable
	 * getNameHash(String obj_type_id) { return (Hashtable
	 * )name_hash.get(obj_type_id); }
	 */
	...
	/*
	 * // установить список имен объектов типа obj_type_id public static void
	 * putNameHash(String obj_type_id, Hashtable hash2) {
	...
	public static void remove(String obj_type_id, String obj_id)
	{
		...
		// удаляем объект
		hash2.remove(obj_id);
		if (hash2.isEmpty()) obj_hash.remove(obj_type_id);
	}
	 ...
	 * получаем список имен всех объектов типа obj_type_id Hashtable hash2 =
	 * (Hashtable )name_hash.get(obj_type_id); if(hash2 == null) // если такого
	 * списка нет, то есть { // нет ни одного объекта данного return; // типа,
	 * то ничего не делаем } // удаляем имя объекта hash2.remove(obj_id);
	 * if(hash2.isEmpty()) name_hash.remove(obj_type_id); }
	 */
	...
	/*
	 * // удалить список имен объектов типа obj_type_id public static void
	 * removeNameHash(String obj_type_id) { name_hash.remove(obj_type_id); }
	 */
