...
public class WindowTileHorizontalCommand extends VoidCommand 
{
	...
	public WindowTileHorizontalCommand()
	{
	}

	public WindowTileHorizontalCommand(Dispatcher dispatcher, JDesktopPane desktop)
	{
		this.dispatcher = dispatcher;
		this.desktop = desktop;
	}

	public WindowTileHorizontalCommand(JDesktopPane desktop)
	{
	...
	public Object clone()
	{
		return new WindowTileHorizontalCommand(dispatcher, desktop);
	}
