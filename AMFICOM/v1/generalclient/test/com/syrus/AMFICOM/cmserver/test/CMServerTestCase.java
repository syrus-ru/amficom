...
public class CMServerTestCase extends TestCase {
	...
	public void _testRecieveAnalyses() throws AMFICOMRemoteException, CreateObjectException, RetrieveObjectException, ObjectNotFoundException {
        ...
        for (int i = 0; i < Analysis_Transferables2.length; i++) {
            Identifier id = new Identifier(Analysis_Transferables2[i].header.id);
    ...
    public void _testRecieveAnalysisTypes() throws AMFICOMRemoteException, CreateObjectException {
        ...
        for (int i = 0; i < analysisType_Transferables2.length; i++) {
            Identifier id = new Identifier(analysisType_Transferables2[i].header.id);
    ...
    public void _testRecieveEvaluationTypes() throws AMFICOMRemoteException, CreateObjectException {
        ...
        for (int i = 0; i < EvaluationType_Transferables2.length; i++) {
            Identifier id = new Identifier(EvaluationType_Transferables2[i].header.id);
            System.out.println("the object has been recieved with id " + id);            
        }
    ...
    public void _testRecieveMeasurementTypes() throws AMFICOMRemoteException, CreateObjectException {
        ...
        for (int i = 0; i < measurementType_Transferables2.length; i++) {
            Identifier id = new Identifier(measurementType_Transferables2[i].header.id);
            System.out.println("the object has been recieved with id " + id);            
        }
    ...
    public void _testRecieveParameterTypes() throws AMFICOMRemoteException, CreateObjectException {
        ...
        for (int i = 0; i < ParameterType_Transferables2.length; i++) {
            Identifier id = new Identifier(ParameterType_Transferables2[i].header.id);
            System.out.println("the object has been recieved with id " + id);            
        }
    ...
    public void _testRecieveSets() throws AMFICOMRemoteException, CreateObjectException {
        ...
        for (int i = 0; i < set_Transferables2.length; i++) {
            Identifier id = new Identifier(set_Transferables2[i].header.id);
            System.out.println("the object has been recieved with id " + id);            
        }
    ...
    public void _testTransmitDomainX() throws AMFICOMRemoteException {
		...
		Identifier_Transferable id_Tf = domain_Transferable.header.id;
	...
	public void _testTransmitAnalysisTypeX() throws AMFICOMRemoteException {
		...
		Identifier_Transferable id_Tf = analysisType_Transferable.header.id;
		long time2 = System.currentTimeMillis();
	...
	public void _testTransmitEvaluationTypeX() throws AMFICOMRemoteException {
		...
		Identifier_Transferable id_Tf = EvaluationType_Transferable.header.id;
		long time2 = System.currentTimeMillis();
	...
	public void _testTransmitMeasurementTypeX() throws AMFICOMRemoteException {
		...
		Identifier_Transferable id_Tf = MeasurementType_Transferable.header.id;
		long time2 = System.currentTimeMillis();
	...
	public void _testTransmitMeasurementX() throws AMFICOMRemoteException {
		...
		Identifier_Transferable id_Tf = measurement_Transferable.header.id;
		long time2 = System.currentTimeMillis();
	...
	public void _testTransmitMonitoredElementX() throws AMFICOMRemoteException {
		...
		Identifier_Transferable id_Tf = monitoredElement_Transferable.header.id;
		long time2 = System.currentTimeMillis();
	...
	public void _testTransmitParameterTypeX() throws AMFICOMRemoteException {
		...
		Identifier_Transferable id_Tf = parameterType_Transferable.header.id;
		long time2 = System.currentTimeMillis();
	...
	public void _testTransmitResultX() throws AMFICOMRemoteException {
		...
		if (result_Transferables.length > 0) {
			...
			Identifier_Transferable id_Tf = result_Transferable.header.id;
			long time2 = System.currentTimeMillis();
	...
	public void _testTransmitTestX() throws AMFICOMRemoteException {
		...
		Identifier_Transferable id_Tf = test_Transferable.header.id;
		long time2 = System.currentTimeMillis();
	...
	public void _testTransmitSetX() throws AMFICOMRemoteException {
		...
		Identifier_Transferable id_Tf = set_Transferable.header.id;
		long time2 = System.currentTimeMillis();
