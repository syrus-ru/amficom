/*-
 * $Id: TestFactory.java,v 1.3 2005/06/23 18:45:09 bass Exp $
 *
...
final class TestFactory extends StorableObjectFactory {
	...
	protected StorableObject newInstance(final IDLEntity transferable) throws CreateObjectException {
		return new Test((IdlTest) transferable);
	}
	...
	protected Identifier getId(final IDLEntity transferable) {
		return new Identifier(((IdlTest) transferable).header.id);
	}
