/*-
 * $Id: MeasurementTypeFactory.java,v 1.3 2005/06/23 18:45:08 bass Exp $
 *
...
final class MeasurementTypeFactory extends StorableObjectFactory {
	...
	protected StorableObject newInstance(final IDLEntity transferable) throws CreateObjectException {
		return new MeasurementType((IdlMeasurementType) transferable);
	}
	...
	protected Identifier getId(final IDLEntity transferable) {
		return new Identifier(((IdlMeasurementType) transferable).header.id);
	}
