/*-
 * $Id: AnalysisFactory.java,v 1.3 2005/06/23 18:45:08 bass Exp $
 *
...
final class AnalysisFactory extends StorableObjectFactory {
	...
	protected StorableObject newInstance(final IDLEntity transferable) throws CreateObjectException {
		return new Analysis((IdlAnalysis) transferable);
	}
	...
	protected Identifier getId(final IDLEntity transferable) {
		return new Identifier(((IdlAnalysis) transferable).header.id);
	}
