/*-
 * $Id: DatabaseMeasurementObjectLoader.java,v 1.57 2005/04/25 09:48:05 bob Exp $
 *
...
/**
 * @version $Revision: 1.57 $, $Date: 2005/04/25 09:48:05 $
 * @author $Author: bob $
...
public class DatabaseMeasurementObjectLoader extends DatabaseObjectLoader implements MeasurementObjectLoader {
	...
	private void saveStorableObjects(final java.util.Set storableObjects, final boolean force) throws ApplicationException {
		...
		database.update(storableObjects, SessionContext.getAccessIdentity().getUserId(), force ? StorableObjectDatabase.UPDATE_FORCE : StorableObjectDatabase.UPDATE_CHECK);
	}	
