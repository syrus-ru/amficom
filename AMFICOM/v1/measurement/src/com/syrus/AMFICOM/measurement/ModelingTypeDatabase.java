/*-
 * $Id: ModelingTypeDatabase.java,v 1.54 2005/08/29 09:58:59 arseniy Exp $
 *
...
/**
 * @version $Revision: 1.54 $, $Date: 2005/08/29 09:58:59 $
...
public final class ModelingTypeDatabase {
	...
	public static void insertAll() throws CreateObjectException {
		...
		try {
			...
			Log.debugMessage("ModelingTypeDatabase.insertAll | Trying: " + sql, Log.DEBUGLEVEL09);
			for (final ModelingType modelingType : ModelingType.values()) {
				...
				Log.debugMessage("ModelingTypeDatabase.insertAll | Inserting modiling type '" + modelingType.getCodename() + "'",
						Log.DEBUGLEVEL09);
