/*
 * $Id: Result.java,v 1.82 2005/10/30 15:20:39 bass Exp $
 *
...
/**
 * @version $Revision: 1.82 $, $Date: 2005/10/30 15:20:39 $
 * @author $Author: bass $
	...
	protected synchronized void fromTransferable(final IdlStorableObject transferable) throws ApplicationException {
		...
		switch (this.sort) {
			...
			case ResultSort._RESULT_SORT_MODELING:
				...
				break;
			default:
				assert Log.errorMessage("Illegal sort: " + this.sort + " of result '" + super.id + "'");
		}
