/*-
 * $Id: AnalysisTypeEnum.java,v 1.1 2005/08/19 17:48:49 arseniy Exp $
 *
...
import com.syrus.AMFICOM.measurement.corba.IdlAnalysisTypeEnum;
 ...
 * @module measurement
 */
public enum AnalysisTypeEnum implements TransferableObject {
	DADARA("dadara",
			...
			EnumSet.of(MeasurementTypeEnum.REFLECTOMETRY)),
	UNKNOWN("unknown",
			EnumSet.noneOf(ParameterType.class),
			EnumSet.noneOf(ParameterType.class),
			EnumSet.noneOf(ParameterType.class),
			EnumSet.noneOf(ParameterType.class),
			EnumSet.noneOf(MeasurementTypeEnum.class));
	...
	private EnumSet<MeasurementTypeEnum> measurementTypes;
	private String description;


	private AnalysisTypeEnum(final String codename,
			...
			final EnumSet<MeasurementTypeEnum> measurementTypes) {
	...
	public static AnalysisTypeEnum fromInt(final int code) {
		switch (code) {
			case IdlAnalysisTypeEnum._DADARA:
				return DADARA;
			default:
	...
	public static AnalysisTypeEnum fromTransferable(final IdlAnalysisTypeEnum idlAnalysisType) {
	...
	public EnumSet<MeasurementTypeEnum> getMeasurementTypes() {
	...
	public IdlAnalysisTypeEnum getTransferable(final ORB orb) {
		return IdlAnalysisTypeEnum.from_int(this.getCode());
	}
