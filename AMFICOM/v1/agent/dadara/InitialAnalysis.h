...
//Internal parameters;
	int evSizeC; // יגפגלזופןגף שךפךןג נזפגדגזוםûןנתנ ץנק‎זךף
	int evSizeW; // יגפגלזופןגף שךפךןג ןונזפגדגזוםûןנתנ ץנק‎זךף
	int lastNonZeroPoint;
	double meanAttenuation; // ץפוהןוו ÿגזטיגןךו פוצםולזנתפגממ‎
	EPLIST epVector;
