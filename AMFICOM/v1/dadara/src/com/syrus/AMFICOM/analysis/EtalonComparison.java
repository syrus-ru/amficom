...
public interface EtalonComparison {
	/**
	 * ¬озвращает список полученных несоответствий, not null
	...
	/**
	 * ¬озвращает общие параметры качества р/г, полученные по результатам сравнени€, not null
	 * в соответствии с контрактом {@link ReflectometryEvaluationOverallResult}
	 * @return общие параметры качества р/г, полученные по результатам сравнени€, not null
	 */
	ReflectometryEvaluationOverallResult getOverallResult();
	/**
	 * ¬озвращает параметры качества р/г по каждому событию, полученные по результатам сравнени€, not null 
	 * в соответствии с контрактом {@link EvaluationPerEventResult}
	 * @return параметры качества р/г по каждому событию, полученные по результатам сравнени€, not null
	 */
