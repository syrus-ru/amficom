...
public final class UIStorage {
	...
	public static final Image				SCHEDULING_ICON_MINI	= Toolkit
																			.getDefaultToolkit()
																			.getImage("images/main/scheduling_mini.gif");
	 ...
	 */
	public static JRadioButton createRadioButton(final String title, final Action action) {
