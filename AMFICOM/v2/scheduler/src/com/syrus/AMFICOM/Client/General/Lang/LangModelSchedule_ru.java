...
// Menu tooltips
		...
		{ "ZoomNoneToolTip", "Фактический размер"},
		{ "CalendarButtonToolTip", "Календарь"},
		{ "ApplyButtonToolTip", "Применить"},
...
// Label strings
		...
		{ "labelOnetime", "Одноразовое" },
		{ "labelContinual", "Непрерывное" },
		{ "labelPeriod", "Периодическое" },
		...
		// added by D.V.A:
		{ "labelUsePattern", "Использовать шаблон"},
		{ "labelUseParameters", "Использовать параметры"},
		{ "labelTogether" , "Одновременно"},
		{ "labelInTurn" , "Поочередно"},
		{ "labelApply" , "Применить"},
		{ "labelCreate" , "Создать"},
