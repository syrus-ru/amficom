...
// Parameters for the Connectors
			...
			Log.errorMessage("Exception while converting byte array to ReflectogramEvent: " + e.getMessage());
...
// Parameters for the Connectors
	...
	public byte[] getByteArray() {
		...
		try {
			...
			Log.errorMessage("Exception while getting byte array from reflectogram event: " + ioe.getMessage());
