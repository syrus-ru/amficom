/*
 * $Id: UnitsOfQP1643ACharacteristrics.java,v 1.1 2005/04/08 15:31:49 bob Exp $
 *
		...
		if (false) {
			{
				...
				AdministrationStorableObjectPool.putStorableObject(resolutionType);
				...
				AdministrationStorableObjectPool.putStorableObject(resolutionCharacteristic);
			}

			{
				...
				AdministrationStorableObjectPool.putStorableObject(waveLengthType);
				...
				AdministrationStorableObjectPool.putStorableObject(characteristic);
			}

			{
				...
				AdministrationStorableObjectPool.putStorableObject(averageCountType);
...

			{
				...
				AdministrationStorableObjectPool.putStorableObject(traceLengthType);
...

			{
				...
				AdministrationStorableObjectPool.putStorableObject(pulseWidthType);
