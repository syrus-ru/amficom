//////////////////////////////////////////////////////////////////////
// $Id: OTAUController.cpp,v 1.1.1.1 2005/10/06 15:48:55 cvsadmin Exp $
// 
// Syrus Systems.
// оЅ’ёќѕ-‘≈»ќ…ё≈”Ћ…  √≈ќ‘“
// 2004-2005 ««.
...
void* OTAUController::run(void* args) {
	...
	const unsigned int twms = otauController->timewait * 1000;	//ѕеревести в миллисекунды

	unsigned int holdConnectionMessageSentTimeout = 0; //—екунды
